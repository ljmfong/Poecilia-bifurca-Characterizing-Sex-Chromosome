...
def main():
    ...
    for infile in infiles:
        ...
        uniqid = name.split("_")[1] + name.split("_")[2] #depends on naming of files; the uniqid should be something that is unique to each sample
        #In this case, we are splitting up the "bif_sex_individ_RNA_...." into just the sex and inidividual number, e.g. "Female1" or "Male2"
