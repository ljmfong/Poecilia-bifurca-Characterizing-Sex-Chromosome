...
Normalize your read counts using  final-cleaned-edgeR-normalisation.Rscript

    /Linux/bin/python L02.calculate_fold_change_bifurca.py bifurca_read_counts_rpkm_normalised.txt bifurca_gene_position.txt bifurca_all_individs_outfile_rpkm_fc_pos.txt
    ...
    /Linux/bin/python L02.calculate_fold_change_bifurca.py bifurca_read_counts_rpkm_normalised.txt scaffold_to_LG.txt bifurca_all_individs_outfile_rpkm_fc_pos_wLG.txt
