...
def get_file_dict(infolders, filedictionary):
    for infolder in infolders:
        ...
        for infile in infiles:
            if infile.endswith("stringtie.1.bygene"):
...
def main():
    ...
    outfilename = args.outfilepath+"/bifurca.Femalegenome.female_male.genesgtffiltered.stringtie.1.bygene.fc.assignedchromosome"
